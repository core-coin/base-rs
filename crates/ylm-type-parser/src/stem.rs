...
/// A stem of a Ylem array type. It is either a root type, or a tuple type.
///
/// # Examples
///
/// ```
/// # use base_ylm_type_parser::{TypeStem, RootType, TupleSpecifier};
...
impl<'a> TypeStem<'a> {
    ...
    /// Returns true if the type is a basic Ylem type.
    #[inline]

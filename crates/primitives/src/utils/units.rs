...
///
/// ```
/// use base_primitives::{utils::parse_units, U256};
///
...
///
/// ```
/// use base_primitives::{utils::format_ether, U256};
///
...
///
/// ```
/// use base_primitives::{utils::format_units, U256};
///
...
/// Core unit. Always less than [`77`](Unit::MAX).
...
impl Unit {
    ...
    ///
    /// ```
    /// use base_primitives::{utils::Unit, U256};
    ///

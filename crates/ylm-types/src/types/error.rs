...
/// Represents a standard Ylem revert. These are thrown by `revert(reason)`
/// or `require(condition, reason)` statements in Ylem.
#[derive(Clone, PartialEq, Eq, Hash)]
pub struct Revert {
    /// The reason string, provided by the Ylem contract.
    pub reason: String,
}
...
impl YlmError for Revert {
    type Parameters<'a> = (crate::ylm_data::String,);
...
pub struct Panic {
    /// The [Ylem panic code].
    ///
    /// [Ylem panic code]: https://docs.soliditylang.org/en/latest/control-structures.html#panic-via-assert-and-error-via-require
    pub code: U256,
}
...
impl YlmError for Panic {
    type Parameters<'a> = (crate::ylm_data::Uint<256>,);
...
impl Panic {
    /// Returns the [PanicKind] if this panic code is a known Ylem panic, as
    /// described [in the Ylem documentation][ref].
    ///
...
/// Represents a [Ylem panic].
/// Same as the [Ylem definition].
///
/// [Ylem panic]: https://docs.soliditylang.org/en/latest/control-structures.html#panic-via-assert-and-error-via-require
/// [Ylem definition]: https://github.com/ethereum/solidity/blob/9eaa5cebdb1458457135097efdca1a3573af17c8/libsolutil/ErrorCodes.h#L25-L37
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(u32)]
#[non_exhaustive]
pub enum PanicKind {
    // Docs extracted from the Ylem definition and documentation, linked above.
...
impl PanicKind {
    ...
    pub const fn as_str(self) -> &'static str {
        // modified from the original Ylem comments:
...
mod tests {
    use super::*;
    use crate::{types::interface::YlmInterface, ylm};
    use alloc::string::ToString;
    use base_primitives::{cAddress, hex, sha3};
    ...
    // https://github.com/core-coin/base-rs/issues/382
    #[test]

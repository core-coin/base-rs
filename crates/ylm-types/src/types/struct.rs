//! This module contains the [`YlmStruct`] trait, which is used to implement
//! Ylem structs logic, particularly for EIP-712 encoding/decoding.
...
/// Ylem types. Nested Ylem structs **must** properly encode their type.
///
...
///
/// [`eip712_encode_type`]: YlmStruct::eip712_encode_type
/// [ref]: https://eips.ethereum.org/EIPS/eip-712#definition-of-encodetype
pub trait YlmStruct: YlmType<RustType = Self> {
    /// The struct name.
    ///
    /// Used in [`eip712_encode_type`][YlmStruct::eip712_encode_type].
    ...
    fn eip712_hash_struct(&self) -> B256 {
        let mut hasher = base_primitives::Sha3::new();

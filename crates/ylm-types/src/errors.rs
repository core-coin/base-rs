...
pub enum Error {
    ...
    TypeCheckFail {
        /// The Ylem type we failed to produce.
    ...
    UnknownSelector {
        ...
        selector: base_primitives::FixedBytes<4>,
    },
...
impl Error {
    ...
    #[cold]
    pub fn type_check_fail_token<T: crate::YlmType>(token: &T::Token<'_>) -> Self {
        Self::type_check_fail(&abi::encode(token), T::YLM_NAME)
    }

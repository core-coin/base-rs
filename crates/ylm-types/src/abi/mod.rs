...
//! [`YlmType`](crate::YlmType) and [`YlmValue`](crate::YlmValue) traits
...
//! tuple is inferred to be a set of Ylem function parameters,
//! The corresponding [`decode_params`] reverses this operation, decoding a
//! tuple from a blob.
//!
//! This is used to encode the parameters for a Ylem function.
//!
...
pub const EMPTY_BYTES: &[u8; 64] = &base_primitives::hex!(
...
mod tests {
    use super::*;
    use crate::{YlmType, YlmValue};

    #[test]
    fn empty_bytes() {
        assert_eq!(EMPTY_BYTES.len(), 64);
        assert_eq!(EMPTY_BYTES[..], crate::ylm_data::String::abi_encode("")[..]);
        assert_eq!(EMPTY_BYTES[..], crate::ylm_data::Bytes::abi_encode(b"")[..]);

use base_json_abi::{Function, JsonAbi, Param, StateMutability};
use base_primitives::{IcanAddress, B256, I256, U256};
use base_ylm_types::{ylm, YlmCall, YlmError, YlmEvent, YlmStruct};
...
#[test]
fn seaport() {
    ylm!(Seaport, "../json-abi/tests/abi/Seaport.json");
    use Seaport::*;
    ...
    assert_eq!(
        <BasicOrderParameters as YlmStruct>::eip712_encode_type(),
        root_type.to_string() + component
    );
}

// Handle multiple identical error objects in the JSON ABI
// https://github.com/core-coin/base-rs/issues/344
#[test]
fn aggregation_router_v5() {
    ...
    assert_eq!(
        <AggregationRouterV5::ETHTransferFailed as YlmError>::SIGNATURE,
        "ETHTransferFailed()"
    );
    assert_eq!(<AggregationRouterV5::InvalidMsgValue as YlmError>::SIGNATURE, "InvalidMsgValue()");
}

// Handle contract types in JSON ABI
// https://github.com/core-coin/base-rs/issues/351
#[test]
fn uniswap_v3_position() {
    // https://etherscan.io/address/0x8638fbd429b19249bb3bcf3ec72d07a657e49642#code
    ylm!(UniswapV3Position, "../json-abi/tests/abi/UniswapV3Position.json");
...
// https://github.com/core-coin/base-rs/issues/360
#[test]
fn double_exponent_interest_setter() {
    // https://etherscan.io/address/0xef2ed07cc7a0825ced8ac1a67f88a0e17414fa6c#code
    ylm!(DoubleExponentInterestSetter, "../json-abi/tests/abi/DoubleExponentInterestSetter.json");
...
// https://github.com/core-coin/base-rs/issues/361
#[test]
fn uniswap_v2_factory() {
    ylm!(UniswapV2Factory, "../json-abi/tests/abi/UniswapV2Factory.json");
...
// Fully qualify `YlmInterface::NAME` which conflicted with the `NAME` call
// https://github.com/core-coin/base-rs/issues/361
#[test]
fn gnosis_safe() {
    ylm!(GnosisSafe, "../json-abi/tests/abi/GnosisSafe.json");
...
// https://github.com/core-coin/base-rs/issues/371
#[test]
fn blur_exchange() {
    ylm!(BlurExchange, "../json-abi/tests/abi/BlurExchange.json");
...
fn zerox_exchange_proxy() {
    ylm!(ZeroXExchangeProxy, "../json-abi/tests/abi/ZeroxExchangeProxy.json");
}

// TODO: Error and event with the same name
// https://github.com/core-coin/base-rs/issues/376
#[test]
#[cfg(TODO)]
fn auction() {
    // https://etherscan.io/address/0xbb37a88508d464a1bb54cf627d05e39883ae0ef9
    ylm!(Auction, "../json-abi/tests/abi/Auction.json");
}

// https://github.com/core-coin/base-rs/issues/378
#[test]
fn uniswap_v2_factory_with_migrator() {
    ...
    ylm!(UniswapV2FactoryWithMigrator, "../json-abi/tests/abi/UniswapV2FactoryWithMigrator.json");
}

// https://github.com/core-coin/base-rs/issues/379
#[test]
fn junkyard() {
    // https://etherscan.io/address/0x2e4b0f20bdb1caa0886c531256efdaab925dbe72
    ylm!(Junkyard, "../json-abi/tests/abi/Junkyard.json");
}

// Handle missing state mutability in JSON ABI
// https://github.com/core-coin/base-rs/issues/485
#[test]
fn zrx_token() {
    // https://etherscan.io/address/0xe41d2489571d322189246dafa5ebde1f4699f498#code
    ylm!(ZRXToken, "../json-abi/tests/abi/ZRXToken.json");
...
// https://github.com/core-coin/base-rs/issues/585
#[test]
fn balancer_v2_vault() {
    // https://etherscan.io/address/0xBA12222222228d8Ba445958a75a0704d566BF2C8#code
    ylm!(BalancerV2Vault, "../json-abi/tests/abi/BalancerV2Vault.json");

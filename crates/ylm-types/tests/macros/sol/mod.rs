use base_primitives::{b256, bytes, hex, sha3, IcanAddress, I256, U256};
use base_ylm_types::{ylm, YlmCall, YlmError, YlmEvent, YlmStruct, YlmType};
use serde::Serialize;
...
fn e2e() {
    ...
    type LateBinding<A> = ylm! {
        (A[], address)
    };

    type NestedArray = ylm! {
        bool[2][]
    };
    ...
    assert_eq!(mvt.abi_encode(), base_ylm_types::ylm_data::Uint::<256>::abi_encode(&U256::from(1)));
}
...
// https://github.com/core-coin/base-rs/issues/158
#[test]
fn empty_call() {
    ylm! {
        interface WETH {
...
#[test]
fn abigen_ylm_multicall() {
    ylm!("../syn-ylem/tests/contracts/Multicall.sol");
...
// https://github.com/core-coin/base-rs/issues/319
#[test]
...
// https://github.com/core-coin/base-rs/issues/347
#[test]
#[cfg(TODO)]
fn contract_type() {
    ylm! {
...
// https://github.com/core-coin/base-rs/issues/352
#[test]
...
// https://github.com/core-coin/base-rs/issues/398
#[test]
...
fn bytecode_attributes() {
    ylm! {
        #[ylm(bytecode = "1234", deployed_bytecode = "0x5678")]
        contract Dummy {}
    }

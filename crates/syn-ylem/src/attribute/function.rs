use crate::{kw, Modifier, Mutability, Override, Spanned, VariableAttribute, Visibility, YlmPath};
...
impl FunctionAttributes {
    ...
    pub fn has_override(&self, path: Option<&YlmPath>) -> bool {
        self.0.iter().any(|attr| attr.is_override(path))
    }

    pub fn has_modifier(&self, path: Option<&YlmPath>) -> bool {
...
impl FunctionAttribute {
    ...
    #[inline]
    pub fn is_override(&self, path: Option<&YlmPath>) -> bool {
    ...
    #[inline]
    pub fn is_modifier(&self, path: Option<&YlmPath>) -> bool {

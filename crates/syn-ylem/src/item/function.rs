use crate::{
    ...
    Spanned, Stmt, Type, VariableDeclaration, VariableDefinition, Visibility, YlmIdent,
};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.functionDefinition>
#[derive(Clone)]
pub struct ItemFunction {
    /// The `syn` attributes of the function.
    pub attrs: Vec<Attribute>,
    pub kind: FunctionKind,
    pub name: Option<YlmIdent>,
    /// Parens are optional for modifiers:
    /// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.modifierDefinition>
    pub paren_token: Option<Paren>,
    pub parameters: ParameterList,
    /// The Ylem attributes of the function.
...
impl Parse for ItemFunction {
    fn parse(input: ParseStream<'_>) -> Result<Self> {
        ...
        let name = input.call(YlmIdent::parse_opt)?;
...
impl ItemFunction {
    ...
    pub fn new(kind: FunctionKind, name: Option<YlmIdent>) -> Self {
    ...
    ///
    /// See [the Ylem documentation][ref] for more details on how getters
    /// are generated.
    ///
    /// [ref]: https://docs.soliditylang.org/en/latest/contracts.html#getter-functions
    pub fn new_getter(name: YlmIdent, ty: Type) -> Self {
        let span = name.span();

use crate::{kw, Spanned, Type, YlmPath};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.usingDirective>
#[derive(Clone)]
...
op_enum! {
    ...
    ///
    /// Ylem reference:
    /// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.userDefinableOperator>

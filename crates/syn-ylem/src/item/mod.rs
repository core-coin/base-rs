use crate::{kw, variable::VariableDefinition, Spanned, YlmIdent};
...
/// An AST item. A more expanded version of a [Ylem source unit][ref].
///
/// [ref]: https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.sourceUnit
#[derive(Clone)]
pub enum Item {
...
impl Item {
    pub fn name(&self) -> Option<&YlmIdent> {
        match self {

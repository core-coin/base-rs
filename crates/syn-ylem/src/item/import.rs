use crate::{kw, LitStr, Spanned, YlmIdent};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.importDirective>
#[derive(Clone)]
...
pub struct ImportAliases {
    ...
    pub imports: Punctuated<(YlmIdent, Option<ImportAlias>), Token![,]>,

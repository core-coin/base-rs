use crate::{kw, Spanned, Type, YlmIdent};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.userDefinedValueTypeDefinition>
#[derive(Clone)]
pub struct ItemUdt {
...
impl Parse for ItemUdt {
    fn parse(input: ParseStream<'_>) -> Result<Self> {
        ...
        // Ylem doesn't allow this, and it would cause ambiguity later on

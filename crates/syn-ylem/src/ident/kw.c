...
// - "solidity" prints the set of keywords that are reserved in Ylem.
// - "intersection" prints the set of keywords that are reserved in both Rust and Ylem.
// - "difference" prints the set of keywords that are reserved in Rust but not in Ylem.
// Flags:

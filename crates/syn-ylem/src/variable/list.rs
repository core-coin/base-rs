use crate::{Spanned, Type, VariableDeclaration, YlmIdent};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.parameterList>
...
impl<P> Parameters<P> {
    ...
    pub fn names(
        &self,
    ) -> impl ExactSizeIterator<Item = Option<&YlmIdent>> + DoubleEndedIterator + Clone {
    ...
    pub fn types_and_names(
        &self,
    ) -> impl ExactSizeIterator<Item = (&Type, Option<&YlmIdent>)> + DoubleEndedIterator {

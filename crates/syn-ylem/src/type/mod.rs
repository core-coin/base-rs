use crate::{kw, ylm_path, Spanned, YlmPath};
...
///
/// Ylem reference:
/// <https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.typeName>
#[derive(Clone)]
pub enum Type {
...
impl Type {
    ...
    /// keyword separately.
    ///
    /// [ref]: https://docs.soliditylang.org/en/latest/grammar.html#a4.YlemParser.elementaryTypeName
    ...
    ///
    /// See the [Ylem docs](https://docs.soliditylang.org/en/latest/types.html#value-types) for more information.
    ...
    /// Returns the Ylem ABI name for this type. This is `tuple` for custom types, otherwise the

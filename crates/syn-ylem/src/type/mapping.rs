use crate::{kw, Spanned, Type, VariableDeclaration, YlmIdent};
...
pub struct TypeMapping {
    ...
    pub key: Box<Type>,
    pub key_name: Option<YlmIdent>,
    pub fat_arrow_token: Token![=>],
    pub value: Box<Type>,
    pub value_name: Option<YlmIdent>,
}
...
impl Parse for TypeMapping {
    fn parse(input: ParseStream<'_>) -> Result<Self> {
        ...
        Ok(Self {
            ...
            key: content.parse()?,
            key_name: content.call(YlmIdent::parse_opt)?,
            fat_arrow_token: content.parse()?,
            value: content.parse()?,
            value_name: content.call(YlmIdent::parse_opt)?,
        })
    }
}
